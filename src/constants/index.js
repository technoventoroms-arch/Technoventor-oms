...
/** Read-only cross-department visibility for the Management panel (dashboard, all orders, department overviews). */
export const MANAGEMENT_VIEW_PERMISSIONS = [
...
/** Operational permissions for the Service department queue and installation workflow. */
export const SERVICE_OPERATIONAL_PERMISSIONS = [
...
export const PERMISSION_TEMPLATES = {
  ...
  'Management': [...MANAGEMENT_VIEW_PERMISSIONS],
  'Procurement Team': [
    PERMISSIONS.VIEW_DASHBOARD,
    PERMISSIONS.VIEW_ALL_ORDERS,
    PERMISSIONS.VIEW_ORDER_OVERVIEW,
  ...
  'Service Team': [...MANAGEMENT_VIEW_PERMISSIONS, ...SERVICE_OPERATIONAL_PERMISSIONS],
  'View Only': [
    PERMISSIONS.VIEW_DASHBOARD,
    PERMISSIONS.VIEW_ASSIGNED_ORDERS,
    PERMISSIONS.VIEW_ORDER_OVERVIEW,
