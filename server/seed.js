...
const SAMPLE_USERS = [
  ...
  { name: 'Arjun Reddy', email: 'arjun@company.com', department: 'service', password: 'serv123', permissions: ['view_dashboard','view_assigned_orders','view_order_overview','view_project_name','view_customer_name','view_boq','view_order_history','view_installation','edit_installation','view_service','edit_service','view_planning','escalate_orders'], isActive: true },
