...
const SAMPLE_USERS = [
  { name: 'Super Admin', email: 'admin@company.com', department: 'admin', password: 'admin123', permissions: ['view_dashboard','view_all_orders','view_assigned_orders','create_order','view_order_overview','view_project_name','view_customer_name','view_boq','view_order_value','view_order_history','view_procurement','edit_procurement','view_vendor_name','view_vendor_rates','view_advance_details','view_finance','edit_finance','approve_payments','view_payment_receipts','view_stores','edit_stores','view_dispatch','edit_dispatch','view_invoicing','edit_invoicing','view_delivery','edit_delivery','view_installation','edit_installation','view_service','edit_service','view_planning','edit_planning','escalate_orders','delete_orders','edit_orders','export_data','manage_users','manage_permissions','view_settings','edit_settings'], isActive: true },
  ...
  { name: 'Vikram Singh', email: 'vikram@company.com', department: 'dispatch', password: 'disp123', permissions: ['view_dashboard','view_assigned_orders','view_order_overview','view_project_name','view_customer_name','view_boq','view_order_history','view_dispatch','edit_dispatch','view_delivery','edit_delivery','escalate_orders'], isActive: true },
  { name: 'Arjun Reddy', email: 'arjun@company.com', department: 'service', password: 'serv123', permissions: ['view_dashboard','view_all_orders','view_order_overview','view_project_name','view_customer_name','view_boq','view_order_value','view_order_history','create_order','escalate_orders','view_procurement','view_vendor_name','view_finance','view_stores','view_dispatch','export_data','view_planning','view_installation','edit_installation','view_service','edit_service'], isActive: true },
